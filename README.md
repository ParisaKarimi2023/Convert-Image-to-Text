...
<li>To preprocess images for higher OCR accuracy.</li>

<li>To use open-source libraries for image processing and text recognition.</li>

<li>To generate output in a readable text format (.txt).</li>
</ul>

## Libraries
<ul>
<li>Pytesseract – Python wrapper for Google Tesseract OCR</li>

<li>OpenCV (cv2) – Used for image preprocessing</li>

<li>Pillow (PIL) – Image loading and format support</li>

<li>NumPy – Numerical operations during preprocessing</li>
</ul>
